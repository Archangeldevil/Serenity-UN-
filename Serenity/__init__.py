...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "Serenity/elevated_users.json")
...
if ENV:
    ...
    import Serenity.config as Config

    API_ID_KEY = Config.API_ID
    API_HASH_KEY = Config.API_HASH
    STRING_SESSION = Config.STRING_SESSION
    MONGO_DB_URL = Config.MONGO_DB_URL
    with open(os.path.join(os.getcwd(), "Serenity/elevated_users.json"), "r") as f:
        data = json.load(f)
    SIBYL = data["SIBYL"]
...
harpia = TelegramClient('vieillot', API_ID_KEY, API_HASH_KEY).start(bot_token=BOT_TOKEN)
